...
// in simulator we redefine to format for Toteka Developer console
...
{\
	NSString * exceptionName = [@"org.toteka." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.toteka";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITotekaNativeItemNone = -1, 
	UITotekaNativeItemSpinner = -2,
	UITotekaNativeItemProgressBar = -3,
	
	UITotekaNativeItemSlider = -4,
	UITotekaNativeItemSwitch = -5,
	UITotekaNativeItemMultiButton = -6,
	UITotekaNativeItemSegmented = -7,
	
	UITotekaNativeItemTextView = -8,
	UITotekaNativeItemTextField = -9,
	UITotekaNativeItemSearchBar = -10,
	
	UITotekaNativeItemPicker = -11,
	UITotekaNativeItemDatePicker = -12,
	
	UITotekaNativeItemInfoLight = -13,
	UITotekaNativeItemInfoDark = -14,
	
	UITotekaNativeItemDisclosure = -15,
	
	UITotekaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Toteka instances of
