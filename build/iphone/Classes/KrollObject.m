 ...
 * Copyright (c) 2009-2011 by Toteka, Inc. All Rights Reserved.
...
//@interface TotekaObject : NSObject
//@end

@interface TotekaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TotekaObject class]])
		{
			for (NSString *key in [[(TotekaObject*)o modules] allKeys])
			{
